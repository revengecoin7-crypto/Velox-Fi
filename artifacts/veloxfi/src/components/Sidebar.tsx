  ...
  return (
    <>
      ...
      <aside className={`sidebar${open ? " sidebar-open" : ""}`}>
        ...
        {/* Help / Contact — external community channels */}
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div className="sb-section">GET HELP</div>
          <a
            ...
            className="sb-item"
          >
            <span className="ico"><TelegramIcon size={16} /></span>
            Telegram
            <span className="badge" style={{ background: "var(--cyan)" }}>24/7</span>
          </a>
          <a
            ...
            className="sb-item"
          >
            <span className="ico"><XIcon size={16} /></span>
            DM on X
          </a>
        </div>
