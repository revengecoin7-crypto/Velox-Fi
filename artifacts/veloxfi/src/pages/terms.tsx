...
const SECTIONS = [
  ...
  { id: "prohibited", icon: "🚫", color: "var(--tomato)",  title: "6. Prohibited users",
  ...
  { id: "liability",  icon: "⚖",  color: "var(--lavender)",title: "7. Limitation of liability",
  ...
  { id: "changes",    icon: "🔄", color: "var(--cyan)",    title: "8. Changes to terms",
