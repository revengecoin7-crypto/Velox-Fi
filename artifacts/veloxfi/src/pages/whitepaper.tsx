  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <div
            className="font-orbitron text-xs tracking-widest mb-0.5"
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <span className="font-orbitron text-xs tracking-wider" style={{ color: "#6b7280" }}>
          {label}
        </span>
      </div>
      <span
...
const PHASES = [
  {
    num: "01",
    name: "BUILD",
    items: ["Core platform development", "Smart contract audit", "Demo mode launch", "$BATTLE token deployment on pump.fun"],
    color: "#2563eb",
    done: true,
  },
  {
    num: "02",
    name: "PRESALE",
    items: ["$BATTLE presale — June 1, 2026", "Early community building", "Whitelist & OG badge distribution", "DexScreener listing"],
    color: "#7c3aed",
    done: false,
  },
  {
    num: "03",
    name: "LAUNCH",
    items: ["VeloxFi mainnet goes live", "First official battles", "Leaderboard Season 1 opens", "DexScreener boosts"],
    color: "#f59e0b",
    done: false,
  },
  {
    num: "04",
    name: "SCALE",
    items: ["Tournament mode", "Mobile-optimised interface", "Referral system launch", "Influencer campaign"],
    color: "#34d399",
    done: false,
  },
  {
    ...
    items: ["Multi-chain bridge exploration", "DAO governance", "VeloxFi grants program", "CEX listing pursuit"],
    color: "#f87171",
    done: false,
  },
];
    ...
    <div style={{ backgroundColor: "#05080f", minHeight: "100vh", color: "white" }}>
      ...
      >
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              href="/VeloxFi-Whitepaper.pdf"
              download
              className="btn-primary px-4 py-2 rounded-lg flex items-center gap-2 text-xs font-orbitron tracking-wider no-underline"
            >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-28 pb-24">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="font-orbitron font-black text-4xl md:text-6xl text-white leading-tight mb-4">
            VELOXFI{" "}
            <span
              style={{
                background: "linear-gradient(135deg,#2563eb,#7c3aed)",
          ...
          <a
            href="/VeloxFi-Whitepaper.pdf"
            download
            className="inline-flex items-center gap-3 px-8 py-4 rounded-xl no-underline transition-all duration-200 hover:opacity-90 active:scale-95"
            style={{
              background: "linear-gradient(135deg, #2563eb, #7c3aed)",
              color: "white",
            }}
          >
            ...
            <span className="font-orbitron font-black tracking-wider">
          ...
          >
            PDF · English · v1.0 — 2026
          </div>
        </div>

        {/* Disclaimer banner */}
        <div
          className="rounded-xl p-4 mb-10 flex gap-3 items-start"
          style={{
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "Inter, sans-serif", color: "#6b7280" }}
          >
            <strong style={{ color: "#f59e0b" }}>DISCLAIMER:</strong> This whitepaper is for informational
            purposes only and does not constitute financial advice. Cryptocurrency investments carry
            significant risk. Never invest more than you can afford to lose. $BATTLE token is a freely
            tradeable token — VeloxFi has no control over who purchases it. Not available to residents
            of the United States or other restricted jurisdictions.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <Section
            ...
            label="01 — ABSTRACT"
            title="What is VeloxFi?"
            color="#2563eb"
          >
            <p className="text-sm leading-relaxed" style={{ fontFamily: "Inter, sans-serif", color: "#6b7280" }}>
              VeloxFi is the <strong style={{ color: "#9ca3af" }}>first decentralised memecoin battle platform
              on Solana</strong>. Users create their own memecoins and pit them against each other in
              real-time price-surge competitions. The coin with the highest percentage price increase
              within a set time period wins the battle.
            </p>
            <p className="text-sm leading-relaxed" style={{ fontFamily: "Inter, sans-serif", color: "#6b7280" }}>
              Unlike traditional memecoin platforms where users passively hold tokens hoping for price
              appreciation, VeloxFi transforms memecoin trading into an <strong style={{ color: "#9ca3af" }}>active,
              competitive experience</strong>. Users become creators, strategists, and competitors — not just holders.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-1">
              {[
                ...
                <div
                  key={label}
                  className="rounded-xl p-3 flex flex-col gap-1 items-center text-center"
                  style={{
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <span>{emoji}</span>
                    <span className="font-orbitron font-black text-xs tracking-widest" style={{ color }}>
                      {who}
                    </span>
                  </div>
          ...
          >
            ...
            {/* Distribution bar */}
            <div className="mt-2">
              <div className="font-orbitron text-xs tracking-widest mb-3" style={{ color: "#374151" }}>
                TOKEN DISTRIBUTION
              </div>
                ...
                {DIST.map(({ label, pct, color }) => (
                  <div key={label} className="flex items-center gap-2">
                    ...
                    <span className="text-xs" style={{ fontFamily: "Inter, sans-serif", color: "#6b7280" }}>
                      {label}
                      <strong className="ml-1.5" style={{ color: "#9ca3af" }}>{pct}%</strong>
                    </span>
                  </div>
                ))}
              </div>
              ...
              {PHASES.map((phase, i) => (
                ...
                >
                  ...
                  <div className="flex flex-col items-center">
                    <div
                      className="w-9 h-9 rounded-xl flex items-center justify-center font-orbitron font-black text-xs flex-shrink-0"
                      style={{
                        background: phase.done
                          ? `${phase.color}20`
                          : "rgba(255,255,255,0.03)",
                        border: `1px solid ${phase.done ? phase.color + "50" : "rgba(255,255,255,0.06)"}`,
                        color: phase.done ? phase.color : "#374151",
                      }}
                    >
                      {phase.num}
                    </div>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${phase.done ? phase.color + "20" : "rgba(255,255,255,0.05)"}`,
                    }}
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <span
                        className="font-orbitron font-black text-sm tracking-wider"
                        style={{ color: phase.done ? phase.color : "#4b5563" }}
                      >
                        PHASE {phase.num} — {phase.name}
                      </span>
                      {phase.done && (
                        <span
                          className="text-xs px-2 py-0.5 rounded-full font-orbitron tracking-widest"
                          style={{
                      ...
                      {phase.items.map((item) => (
                        ...
                        >
                          <ChevronRight
                            ...
                            style={{ color: phase.done ? phase.color : "#374151" }}
                          />
                          {item}
                        </li>
                      ))}
          ...
          >
            <div className="flex-1 text-center sm:text-left">
              ...
              <p
                ...
                style={{ fontFamily: "Inter, sans-serif", color: "#6b7280" }}
              >
                Download the complete PDF for token economics, revenue model, marketing strategy,
                legal section, and full technical specification.
              </p>
            </div>
            <div className="flex items-center gap-3 flex-shrink-0 flex-wrap justify-center">
              <a
                href="/VeloxFi-Whitepaper.pdf"
                download
                className="btn-primary px-6 py-3 rounded-xl flex items-center gap-2 no-underline"
              >
